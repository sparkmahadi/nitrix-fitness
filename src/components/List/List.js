        ...
        <div className='bg-slate-200 px-2 lg:px-5 xl:px-5 2xl:px-10 py-2 md:py-5 w-36 md:w-full text-center md:text-left relative'>
            <div className='sticky top-0'>
                ...
                <div className='grid grid-cols-3 xl:grid-cols-5 gap-2 justify-around items-center bg-slate-300 p-2 md:p-3 2xl:p-5 rounded-xl my-5'>
                    <p className='bg-slate-500 hover:bg-blue-500 lg:px-2 2xl:px-4 md:py-2 py-1 rounded-xl md:font-semibold md:text-md 2xl:text-lg text-white text-center'>10s</p>
                    <p className='bg-slate-500 hover:bg-blue-500 lg:px-2 2xl:px-4 md:py-2 py-1 rounded-xl md:font-semibold md:text-md 2xl:text-lg text-white text-center'>20s</p>
                    <p className='bg-slate-500 hover:bg-blue-500 lg:px-2 2xl:px-4 md:py-2 py-1 rounded-xl md:font-semibold md:text-md 2xl:text-lg text-white text-center'>30s</p>
                    <p className='bg-slate-500 hover:bg-blue-500 lg:px-2 2xl:px-4 md:py-2 py-1 rounded-xl md:font-semibold md:text-md 2xl:text-lg text-white text-center'>40s</p>
                    <p className='bg-slate-500 hover:bg-blue-500 lg:px-2 2xl:px-4 md:py-2 py-1 rounded-xl md:font-semibold md:text-md 2xl:text-lg text-white text-center'>50s</p>
                </div>
                </div>
